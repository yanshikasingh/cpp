...
Use the C++ character facilities from <cctype> where appropriate.
...
void check(char ch)
{
   cout << "Your entered character is :" << ch;
   cout << "\nYour character is is alphabet :";
   if (isalpha(ch))
   {
      cout << "Yes";
   }
   ...
   cout << "\nYour character is is alphabet or digit :";
   if (isalnum(ch))
   {
      cout << "Yes";
   }
   ...
   cout << "\nYour character is is alphabet lower :";
   if (islower(ch))
   {
      cout << "Yes";
   }
   ...
   cout << "\nYour character is is alphabet upper :";
   if (isupper(ch))
   {
      cout << "Yes";
   }
